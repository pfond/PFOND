...
<div class="wrap">
	...
	<div style="margin-left: 30px;">
		...
		?>
		<textarea id="gs_entry_contents" name="gs_entry_contents" placeholder="Entry Contents" rows="20" cols="80" required="required"><?php echo $entryContents; ?></textarea><br /><br />
	</div>
	...
	<?php
		if ($pageAction == "Edit")
		{
			echo '<div style="display: inline-block; margin-left: 75px;"><input type="submit" name="gs_entry_delete" value="Delete Entry" onclick="return confirm(\'Are you sure you want to permanently delete entry '. $entryName .'?\');" /></div>';
