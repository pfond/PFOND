<?php get_header() ?>
	...
	<div id="content">
		...
		<form action="" method="post" id="achievements-directory-form" class="dir-form">
			<h3><?php _e( '<h1 style="font-weight: bold">Achievements Directory</h1>', 'dpa' ) ?><?php if ( dpa_permission_can_user_create() ) : ?> &nbsp;<a class="button" href="<?php dpa_achievements_permalink() ?>/<?php echo DPA_SLUG_CREATE ?>"><?php _e( 'Create an Achievement', 'dpa' ) ?></a><?php endif; ?></h3>
